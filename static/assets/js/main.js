...
(function ($) {
    $('#mathimg').attr('src', 'static/images/' + Math.round(Math.random() * 9 + 1) + '.jpg');
    skel.breakpoints({
    ...
    $(function () {
        ...
        $('.gallery.lightbox').on('click', 'a',
            ...
            }).prepend('<div class="modal" tabIndex="-1"><div class="inner"><img src="" /></div></div>').find('img').on('load',
            function (event) {
